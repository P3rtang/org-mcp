...
func intoOneOfArray[T tools.QueryTableSimple | tools.QueryTableSql](t ...T) []mcp.GenericOneOf[*tools.QueryTableUnion, tools.ApplicableTool] {
	...
	testMap := []TableTest{
		TableTest{
			...
			input: tools.QueryTableInput{
				Queries: intoOneOfArray(tools.QueryTableSimple{

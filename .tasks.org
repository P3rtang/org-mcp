...
** TODO Derive Tool Input Schema from Go Struct using Reflection :jsonrpc:schema:input:
   ...
   This is the main project container for the Org-MCP server.
   It organizes tasks related to parsing, searching, and managing Emacs Org-mode files via the Model Context Protocol.* Test Header
  :PROPERTIES:
  :ID: 56493203
  :END:
  This is the updated text  This is a text entry in the header
...
** TODO Tool Design & AI UX Improvements
   :PROPERTIES:
   :ID: 30384709
   :END:
...
** TODO Tag Management & Discovery Improvements
   :PROPERTIES:
   :ID: 71742063
   :END:
   - [ ] Implement a ~list_tags~ tool or a ~TAGS~ summary in ~status_overview~ to provide a global view of all used tags.
   - [ ] Allow filtering ~query_items~ by multiple tags (AND/OR logic) to improve discovery.
   - [ ] Add a "Tag Cloud" or frequency count to help AI models understand the "Hot Topics" of a project.
